...
function Field({
	...
	return (
		// biome-ignore lint/a11y/useSemanticElements: grouped container
		<div
...
function FieldDescription({ className, ...props }: React.ComponentProps<"p">) {
	return (
		<p
			className={cn(
				"text-left font-normal text-base-500 text-sm leading-normal group-has-[[data-orientation=horizontal]]/field:text-balance [[data-variant=legend]+&]:-mt-1.5",
