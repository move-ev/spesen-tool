...
function RadioGroupItem({ className, ...props }: RadioPrimitive.Root.Props) {
	return (
		<RadioPrimitive.Root
			className={cn(
				"group/radio-group-item peer relative flex aspect-square size-4 shrink-0 rounded-full border border-base-200 text-primary outline-none after:absolute after:-inset-x-3 after:-inset-y-2",
				"outline-2 outline-solid outline-transparent outline-offset-2 focus-visible:outline-accent-500",
